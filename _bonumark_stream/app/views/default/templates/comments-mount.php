...
?>
<section class="stream-comments-mount ledger-comments-mount" aria-label="Conversation" data-comments-mount data-comments-slug="<?= htmlspecialchars((string)($data['slug'] ?? ''), ENT_QUOTES, 'UTF-8') ?>" data-comments-endpoint="<?= htmlspecialchars((string)($data['endpoint'] ?? 'comments.php'), ENT_QUOTES, 'UTF-8') ?>">
