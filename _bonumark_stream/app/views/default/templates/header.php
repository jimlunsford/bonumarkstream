...
$showCountChip = array_key_exists('show_count_chip', $data) ? !empty($data['show_count_chip']) : !$previewMode;
...
$statusLabel = $previewMode ? 'Preview' : (trim((string)($settings['status_label'] ?? 'Live microblog')) ?: 'Live microblog');
