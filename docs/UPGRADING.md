...
Bonumark Stream v0.4.5 keeps the v0.4 clean-break foundation.

## Supported upgrade path

The built-in upgrade tool supports upgrades from v0.4.0 and newer only.

Pre-v0.4 development builds are not supported by the v0.4.x upgrader. Install the current v0.4.x package fresh instead of trying to upgrade an older development build.

## What the upgrader preserves

The upgrader preserves current v0.4.x user-owned data and generated files:
