...
<section class="panel settings-section-panel">
  ...
  <form method="post" class="settings-inline-actions"><input type="hidden" name="csrf_token" value="<?= htmlspecialchars(bms_csrf_token(), ENT_QUOTES, 'UTF-8') ?>"><input type="hidden" name="activitypub_action" value="follow_actor"><label for="actor_uri">Remote actor HTTPS URI</label><input id="actor_uri" name="actor_uri" type="url" required maxlength="2048" placeholder="https://remote.example/users/name"><button type="submit" class="button-link secondary">Follow actor</button></form>
