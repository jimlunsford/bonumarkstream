...
<section class="dashboard-actions-grid">
  ...
  <div class="action-card"><h3>Analytics</h3><p>Review optional cookieless aggregate page-view reporting. Analytics is disabled until an administrator enables it.</p><a class="button-link secondary" href="<?= htmlspecialchars(bms_admin_url('analytics.php'), ENT_QUOTES, 'UTF-8') ?>">Open Analytics</a></div>
