...
function bms_database_smoke_verify_schema(PDO $pdo, string $prefix, array $expectedMigrations, string $label): void
{
    ...
    $requiredColumns = [
        ...
        'activitypub_publication_events' => ['post_id', 'event_type', 'activity_uri', 'state_json', 'payload_json', 'transition_fingerprint', 'status'],
        'activitypub_deliveries' => ['delivery_type', 'event_id', 'activity_uri', 'payload_json', 'dedupe_key', 'inbox_url', 'recipient_actor_ids_json', 'signature_mode', 'attempt_count', 'available_at'],
