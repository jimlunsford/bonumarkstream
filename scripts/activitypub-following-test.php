...
bms_ap_following_assert(str_contains($followingController, "bms_asset_url('assets/stream.js')") && str_contains($streamJs, 'function setupCards(root)') && str_contains($streamJs, "window.location.href = destination.href;"), 'Following cards do not retain the core Stream card-navigation behavior.');
